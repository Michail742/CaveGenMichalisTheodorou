...
public class MapGenerator2 : MonoBehaviour
{
	...
	{
		Vector3 offset = transform.position - caveSpawnPosition;
		foreach (Transform child in transform)
			child.transform.position += offset/2;
		transform.position = caveSpawnPosition;
	}
	...
	void ProcessMap()
	{
		...
		caveSpawnPosition = CoordToWorldPoint(cave);
